...
$menu = mysqli_query($link,"SELECT * FROM forum,forum_akses,guru WHERE forum.id = forum_akses.id_forum AND forum_akses.id_user = guru.id_user AND guru.id_user = $id ORDER BY forum.sub ASC");
//print_r($menu); die();
...
<div class="bungkus">
    ...
    <a href="?w=<?=$bub[0]?>&id=<?=$id?>"><i class="fa fa-comment"></i> <?=$bub[2]?></a>
    <?php } ?>
	</div>
	<div class="mainus">
    <?php if(isset($_GET['w'])){ ?>
